...
// To provide specific penalties, you can directly interface to those instead
// of using the simplified interface in optimization.cpp. This can help you set up a more tailored
